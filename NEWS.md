...
## multipath-tools 0.12.1, 2025/10

Changes already contained in 0.11.3.
...
The bug fixes from 0.12.0 were already included in 0.11.1.
...
* If an existing multipath map is blacklisted in `multipath.conf` and
  ...
  [ This issue has been fixed by updating to 0.12.2 ]
